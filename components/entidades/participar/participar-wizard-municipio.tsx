...
// Wizard dedicado a Município — /participar/municipio. Irmão de
// participar-wizard-freguesia.tsx; antes eram um único componente com um
...
export function ParticiparWizardMunicipio({ municipios }: { municipios: MunicipioOption[] }) {
  ...
  function selecionarMunicipio(m: MunicipioOption | null) {
    setForm((f) => ({
      ...f,
      municipio: m,
      nomeOficial: f.nomeOficialAuto ? (m ? `Câmara Municipal de ${m.nome}` : "") : f.nomeOficial,
    }));
  }
  ...
  function validarPasso(passo: number): boolean {
    ...
    if (passo === 1) {
      if (!form.municipio) erros.municipio = "Seleccione o município.";
  ...
  async function submeter(e: FormEvent) {
    ...
    if (error) {
      if (error.code === "23505") {
        setErroGeral(
          "Já existe um pedido pendente para este município. A nossa equipa está a analisá-lo — não é preciso submeter outra vez."
        );
    ...
    return (
      <div className="mx-auto max-w-2xl rounded-3xl border border-terra-200 bg-white p-8 text-center shadow-sm sm:p-10">
        ...
        <p className="mx-auto mt-4 max-w-lg leading-7 text-terra-600">
          Obrigado por se juntar ao OTJ. Recebemos o pedido de registo do seu município. Depois
        ...
        <div className="mt-8 space-y-2 rounded-2xl bg-terra-50 p-5 text-left text-sm">
          <SummaryRow label="Município" value={form.nomeOficial} />
    ...
    <div className="mx-auto w-full max-w-3xl">
      <div className="mb-10 text-center">
        <span className="inline-flex rounded-full bg-terra-100 px-4 py-1.5 text-sm font-medium text-terra-800">
          Registo institucional — Município
        </span>
      ...
      >
        {step === 1 && (
          <section>
            <Cabecalho titulo="A sua Câmara Municipal" texto="Diga-nos qual é o município que pretende registar." />
            ...
            <div className="space-y-5">
              ...
              <Campo
                ...
                placeholder="Nome oficial do Município"
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-terra-50 p-5">
                ...
                <div className="mt-4">
                  <Campo
                    label="Nome do Presidente da Câmara"
                    required
          ...
          <section>
            ...
            <div className="mt-7 space-y-5">
              <Campo
                ...
                placeholder="nome@camara-municipal.pt"
