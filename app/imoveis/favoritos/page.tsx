...
export default async function FavoritosImoveisPage() {
    ...
    <>
      ...
      <div className="min-h-screen bg-imoveis-50">
        <main className="max-w-6xl mx-auto p-6">
          <h1 className="text-3xl font-bold text-imoveis-900 mb-8">❤️ Favoritos</h1>
          ...
          {ads.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-lg border border-imoveis-200">
              <p className="text-imoveis-700 text-lg mb-4">Ainda não guardaste nenhum imóvel</p>
              <Link href="/imoveis">
