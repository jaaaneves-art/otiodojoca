...
// Segue o mesmo padrão do lib/gran-bazar/ad-types.ts — só 2 tipos
// (venda/leilao), porque foi pedido explicitamente "venda direta +
// leilão", sem troca nem oferta.
//
// "leilao" reaproveita o mesmo motor de leilões do Gran Bazar
// (marketplace_auctions / gran_bazar_place_bid / gran_bazar_advance_auctions)
